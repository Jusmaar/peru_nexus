                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                <h1 class="h1">Recibo de tu compra en PeruvianNexus</h1>
                                                                
                                                                <strong>Hola {{$order->email}}</strong> 

                                                                Te enviamos los datos de tu compra:
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="{{url('/compras/'.$order->shoppingCartID())}}" target="_blank">Mas informacion de la compra</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
